namespace RoboGameNamespace {
    ...
    export let textureLumberer: ƒ.TextureImage = new ƒ.TextureImage("./Art/lumberer.png");
    export let lumbererMaterial: ƒ.Material = new ƒ.Material("MaterialName", ƒ.ShaderTexture, new ƒ.CoatTextured(ƒ.Color.CSS("White"), textureLumberer));
    export let textureMiner: ƒ.TextureImage = new ƒ.TextureImage("./Art/miner.png");
    export let minerMaterial: ƒ.Material = new ƒ.Material("MaterialName", ƒ.ShaderTexture, new ƒ.CoatTextured(ƒ.Color.CSS("White"), textureMiner));
    export let textureOiler: ƒ.TextureImage = new ƒ.TextureImage("./Art/oiler.png");
    export let oilerMaterial: ƒ.Material = new ƒ.Material("MaterialName", ƒ.ShaderTexture, new ƒ.CoatTextured(ƒ.Color.CSS("White"), textureOiler));
    export let textureScrapper: ƒ.TextureImage = new ƒ.TextureImage("./Art/scrapper.png");
    export let scrapperMaterial: ƒ.Material = new ƒ.Material("MaterialName", ƒ.ShaderTexture, new ƒ.CoatTextured(ƒ.Color.CSS("White"), textureScrapper));
    export let textureEnemy: ƒ.TextureImage = new ƒ.TextureImage("./Art/enemy_icon.png");
    export let enemyMaterial: ƒ.Material = new ƒ.Material("MaterialName", ƒ.ShaderTexture, new ƒ.CoatTextured(ƒ.Color.CSS("White"), textureEnemy));
